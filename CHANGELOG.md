...
- GitHub Releaseのタイトル表記を4系統で統一
- パッチ設定行のアイコン・文字位置を公式メニュー項目に揃える
- パッチ設定行の行高・アイコン/文字位置を公式行に厳密に揃える

### Features

- パッチ版の算出をコミット単位の累積bumpに変更
- パッチ設定行に区切り線・歯車アイコンを追加しフォントを公式項目に統一

## [0.5.2-dev] - 2026-07-01
